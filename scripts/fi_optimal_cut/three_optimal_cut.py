...
def get_minutiae_df(img1, img2, img3, img1_m_p, img2_m_p, img3_m_p, points1, points2, points3):
    ...
    minutae_count_img1_2, minutae_count_img2_2, minutae_count_img3_2, minutae_list_filtered_img1_2, minutae_list_filtered_img2_2, minutae_list_filtered_img3_2 = get_filtered_minutae_info_of_images(img1_2, img2_2, img3_2, img1_m_p, img2_m_p, img3_m_p)
    if (minutae_count_img1_2 != 0 and minutae_count_img2_2 != 0 and minutae_count_img3_2 != 0):
        minutae_df = minutae_df.append({'img1_minutae_count': minutae_count_img1_2, 'img2_minutae_count': minutae_count_img2_2, 'img3_minutae_count': minutae_count_img3_2, 'img1_minutae_list_filtered': minutae_list_filtered_img1_2, 'img2_minutae_list_filtered': minutae_list_filtered_img2_2, 'img3_minutae_list_filtered': minutae_list_filtered_img3_2}, ignore_index=True)
    ...
    minutae_count_img1_3, minutae_count_img2_3, minutae_count_img3_3, minutae_list_filtered_img1_3, minutae_list_filtered_img2_3, minutae_list_filtered_img3_3 = get_filtered_minutae_info_of_images(img1_3, img2_3, img3_3, img1_m_p, img2_m_p, img3_m_p)
    if (minutae_count_img1_3 != 0 and minutae_count_img2_3 != 0 and minutae_count_img3_3 != 0):
        minutae_df = minutae_df.append({'img1_minutae_count': minutae_count_img1_3, 'img2_minutae_count': minutae_count_img2_3, 'img3_minutae_count': minutae_count_img3_3, 'img1_minutae_list_filtered': minutae_list_filtered_img1_3, 'img2_minutae_list_filtered': minutae_list_filtered_img2_3, 'img3_minutae_list_filtered': minutae_list_filtered_img3_3}, ignore_index=True)
...
def main():
    ...
    try:
        for root, _, files in os.walk(directory_path):
            ...
            if (img1_cropped_path and img2_cropped_path and img3_cropped_path and img1_minutiae_path and img2_minutiae_path and img3_minutiae_path):           
                if (os.path.getsize(img1_minutiae_path) == 0 or os.path.getsize(img2_minutiae_path) == 0 or os.path.getsize(img3_minutiae_path) == 0):
                    with open(data_txt_path, 'a') as file:
                        file.write('\n' + 'Image Sets - ' + str(os.path.basename(root)) + ',' + str(os.path.basename(img1_cropped_path)) + ',' + str(os.path.basename(img2_cropped_path)) + ',' + str(os.path.basename(img3_cropped_path)))
                    continue
                ...
                if str(os.path.splitext(os.path.basename(img1_cropped_path))[0]) in str(os.path.basename(img1_minutiae_path)) and str(os.path.splitext(os.path.basename(img2_cropped_path))[0]) in str(os.path.basename(img2_minutiae_path)) and str(os.path.splitext(os.path.basename(img3_cropped_path))[0]) in str(os.path.basename(img3_minutiae_path)):
                ...
                center, top_h, bottom_h, left_h, right_h = cal_row_col_mid(first_row, last_row, first_column, last_column)
                
                top_l_h, top_r_h, bottom_l_h, bottom_r_h, left_t_h, left_b_h, right_t_h, right_b_h = get_row_col_second_mid(first_row, last_row, first_column, last_column, top_h, bottom_h, left_h, right_h)
                ...
                minutiae_df_1 = get_minutiae_df(img1_cropped, img2_cropped, img3_cropped, img1_m_p, img2_m_p, img3_m_p, points1_1, points1_2, points1_3)
                minutiae_df_2 = get_minutiae_df(img1_cropped, img2_cropped, img3_cropped, img1_m_p, img2_m_p, img3_m_p, points2_1, points2_2, points2_3)
                minutiae_df_3 = get_minutiae_df(img1_cropped, img2_cropped, img3_cropped, img1_m_p, img2_m_p, img3_m_p, points3_1, points3_2, points3_3)
                minutiae_df_4 = get_minutiae_df(img1_cropped, img2_cropped, img3_cropped, img1_m_p, img2_m_p, img3_m_p, points4_1, points4_2, points4_3)

                minutiae_df_final = pd.concat([minutiae_df_1, minutiae_df_2, minutiae_df_3, minutiae_df_4], axis=0, ignore_index=True)
                ...
                selected_minutiae_df = minutiae_df_final_filtered[(minutiae_df_final_filtered['img1_minutae_count'] == img1_minutiae_count) & (minutiae_df_final_filtered['img2_minutae_count'] == img2_minutiae_count) & (minutiae_df_final_filtered['img3_minutae_count'] == img3_minutiae_count)]
                ...
                morphed_minutiae_save_path = root + '/' + str(os.path.splitext(os.path.basename(img1_cropped_path))[0]) + '_' + str(os.path.splitext(os.path.basename(img2_cropped_path))[0]) + '_' + str(os.path.splitext(os.path.basename(img3_cropped_path))[0]) + '_mm.txt'
        ...
        print('Error -'+ os.path.basename(root) + ',' + os.path.basename(img1_cropped_path) + ',' + os.path.basename(img2_cropped_path) + ',' + os.path.basename(img3_cropped_path) + '-' + str(e))
        traceback.print_exc()
