    ...
    try:
        ...
        for root, _, files in os.walk(directory_path):
            ...
            if (img1_path and img2_path and img3_path):
                ...
                cv2.imwrite(root + '/' + str(os.path.splitext(os.path.basename(img1_path))[0]) + '_cropped.png', img1_transformed_cropped_f)
                cv2.imwrite(root + '/' + str(os.path.splitext(os.path.basename(img2_path))[0]) + '_cropped.png', img2_transformed_cropped_f)
                cv2.imwrite(root + '/' + str(os.path.splitext(os.path.basename(img3_path))[0]) + '_cropped.png', img3_transformed_cropped_f)
                ...
                subprocess.call(["C:/Program Files/ImageMagick-7.1.1-Q16-HDRI/magick.exe", "convert", img3_save_path, "-units", "PixelsPerInch", "-density", "500", img3_save_path], shell=True)
                ...
                # subprocess.call(["convert", img3_save_path, "-units", "PixelsPerInch", "-density", "500", img3_save_path])
        ...
        print('Error -' + os.path.basename(root) + os.path.basename(img1_path) + ',' + os.path.basename(img2_path) + ',' + os.path.basename(img3_path) + '-' +str(e))
        traceback.print_exc()
