    ...
    try:
        ...
        for root, _, files in os.walk(directory_path): 
            ...
            if (img1_cropped_path and img2_cropped_path and img3_cropped_path):
                ...
                img3_minutiae_save_path = root + '/' + str(os.path.splitext(os.path.basename(img3_cropped_path))[0]) + '_minutiae.txt'
        ...
        print('Error -'  + os.path.basename(img1_cropped_path) + ',' + os.path.basename(img2_cropped_path) + ',' + os.path.basename(img3_cropped_path) + '-' + str(e))
        traceback.print_exc()
