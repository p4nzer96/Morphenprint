...
def main():
    ...
    for index, line in enumerate(lines):
        try:
            if len(line) > 0 and line[0] == '{':
                ...
                if (morph_img1_score > 60 and morph_img2_score > 60 and morph_img3_score <= 60) or \
                   (morph_img1_score > 60 and morph_img2_score <= 60 and morph_img3_score > 60) or \
                   (morph_img1_score <= 60 and morph_img2_score > 60 and morph_img3_score > 60):
    ...
    with open(save_results_path, 'a') as file:
        file.write('\n \n' + str(results_category) + ' - (' + str(len(lines)) + ')' + '\n' + 'Score_Anonymous_Count_60 - ' + str(score_anon_count) + ', Score_2Match_Count_60 - ' + str(score_2match_count) + ', Score_1Match_Count_60 - ' + str(score_1match_count))     
